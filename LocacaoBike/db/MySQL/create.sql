...
CREATE TABLE CLIENTE (CPF varchar(11) PRIMARY KEY, sexo varchar(256) NOT NULL, email varchar(256) NOT NULL, nome varchar(256) NOT NULL, senha varchar(256), telefone varchar(256) NOT NULL, datanascimento varchar(45) NOT NULL);
...
INSERT INTO CLIENTE (CPF,sexo,email,nome,senha,telefone,datanascimento)
VALUES
